...
This is the build-free product site for Arcane Client 2.3.4.
...
- `script.js` — fixed-nav state, mobile menu, scroll reveals, FAQ behavior, session-aware Hiss replay, and the code-gated 2.3.4 release download.
