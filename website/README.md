...
This is the build-free product site for Arcane Client 2.3.5.
...
- `script.js` — fixed-nav state, mobile menu, scroll reveals, FAQ behavior, and the code-gated 2.3.5 release download.
