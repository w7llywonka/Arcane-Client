 ...
 *
 * <p><b>Which font.</b> With Caxton present, {@code ui_caxton} renders Sora as multi-channel signed
 ...
 * scales 1 to 6 and the matching one is selected. Every variant shares Sora's metrics, so the
